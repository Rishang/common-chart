...
### Example 1: Basic Secret with Environment Variables
...
### Example 3: ArgoCD Vault Plugin Integration
...
### Example 5: Multiple Secrets

For multiple separate secrets, use the chart multiple times or use `extraObjects`:
